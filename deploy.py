...
# 1. IDENTITY PAGE (ALIEN DROPDOWN FIX)
# Це блок, який розкривається при наведенні
ALIEN_DROPDOWN = """
<div class="alien-container">
    <div class="alien-core">
        <div class="core-header">
            <span class="status-light"></span>
            [ HOVER TO ACCESS DATA STREAMS ]
        </div>
        <div class="core-list">
...
"""
# Додаємо HAL 9000 лінки знизу, як було, але з новим Dropdown зверху
HAL_LINKS = f"""
...
# 2. PHOTO PAGE (GRID FIX - 3 COLS DESKTOP, 1 MOBILE)
PHOTO_CONTENT = """
<h1>/GALLERY_GRID</h1>
<p>Visual Database.</p>
<div class="photo-grid-container">
    <div class="widget-box">
        <div class="widget-header">CAM_01: INSTAGRAM_FEED</div>
    ...
    <div class="widget-box placeholder"><div class="widget-header">CAM_03: OFFLINE</div><div class="static-noise">WAITING...</div></div>
    <div class="widget-box placeholder"><div class="widget-header">CAM_04: OFFLINE</div><div class="static-noise">WAITING...</div></div>
    <div class="widget-box placeholder"><div class="widget-header">CAM_05: OFFLINE</div><div class="static-noise">WAITING...</div></div>
    <div class="widget-box placeholder"><div class="widget-header">CAM_06: OFFLINE</div><div class="static-noise">WAITING...</div></div>
</div>
"""

# 3. TERMINAL (INPUT FIX)
CONTACT_CONTENT = """
<h1>Terminal Access</h1>
<div class='terminal-window'>
    <div id='history'>
        <p>UkrGeekLife OS v18.0...</p>
        <p>Input restored. Type 'help'.</p>
    </div>
...
PROJECTS_CONTENT = """<h1>ARSENAL</h1><ul><li><strong>Growing Box:</strong> Hydroponics.</li><li><strong>Lighting:</strong> Spectrum.</li><li><strong>Global Box:</strong> Architecture.</li></ul><h2>SOCIAL</h2><ul><li><strong>Volunteer Cats:</strong> Helping.</li></ul>"""
...
@media(max-width: 900px) { 
    nav { display: none; position: absolute; top: 50px; right: 0; background: #000; border: 1px solid #0F0; flex-direction: column; width: 200px; } 
...
/* --- FIX 1: PHOTO GRID (3 COLS DESKTOP / 1 MOBILE) --- */
...
/* --- FIX 2: ALIEN DROPDOWN (IDENTITY PAGE) --- */
